...
--     2654 = Intellect (+12 int) [same ID as bracer Major Intellect]
--   Ranged:
...
BiSGearCheckEnchantLinks = {
    ...
    [2657] = { "spell", 34004 },  -- Greater Agility
    ...
    [2649] = { "spell", 27914 },  -- Fortitude
    [2654] = { "spell", 34001 },  -- Major Intellect (also used for Shield - Intellect)
...
local ENCHANTS = {
    ...
    WRIST_MAJOR_INTELLECT  = { 2654, "Enchant Bracer - Major Intellect" },-- +12 int
    ...
    SHIELD_INTELLECT       = { 2654, "Enchant Shield - Intellect" },      -- +12 int [same as bracer]
