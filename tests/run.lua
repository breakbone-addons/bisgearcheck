...
-- Example: lua tests/run.lua test_ep  (runs only test_ep_engine.lua)
...
local function collect_test_functions(env)
    local funcs = {}
...
local function run_test_file(filepath)
    ...
    -- Collect test functions from the module table or from globals
    local test_funcs
